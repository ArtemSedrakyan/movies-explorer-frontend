      ...
      >
        <>
          <label className="form__field-auth">
            ...
            <input className="form__input-auth" type="text" name="name" value={values.name || ""} onChange={handleChange}
            minLength="2" maxLength="30" pattern="^[A-Za-zА-Яа-яЁё /s -]+$" disabled={isSending} required/>
          ...
          <label className="form__field-auth">
            ...
            onChange={handleChange} minLength="8" disabled={isSending} required/>
